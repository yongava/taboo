...
let gameState = {
  ...
  rooms: {
    room1: { playerWord: 'สเต๊ก', otherWords: ['ข้าวซอย', 'ส้มตำ'], revealed: false },
    room2: { playerWord: 'ข้าวซอย', otherWords: ['สเต๊ก', 'ส้มตำ'], revealed: false },
    room3: { playerWord: 'ส้มตำ', otherWords: ['สเต๊ก', 'ข้าวซอย'], revealed: false },
  },
  roomClicked: false
};
